...
public class ApproveDisapproveFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_approve_disapprove, container, false);
        final TextView textView = root.findViewById(R.id.text_approve_disapprove);
        approveDisapproveViewModel.getText().observe(this, new Observer<String>() {
            @Override
