...
public class activity_receive_barcode_bp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
        listView = findViewById(R.id.listViewReceiveBP);
        ...
        fabPlanToSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), activity_batch_processing_receive.class).putExtra("BarcodeData", scannedData));
